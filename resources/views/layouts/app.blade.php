                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        ...
                        <div x-show="open"
                            ...
                            <!-- Add My Activities link -->
                            <a href="{{ route('activities.index') }}" class="block px-4 py-2 text-sm text-text-primary hover:bg-background transition-colors duration-150">
