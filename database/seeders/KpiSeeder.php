    ...
    private function seedTargets(): void
    {
        ...
        $targets = [
            ...
            [
                ...
                'description' => 'Create 5 MEXC accounts this week',
            ...
            [
                ...
                'description' => 'Create 5 email accounts this week',
            ...
            [
                'name' => 'Weekly Proxies',
                'description' => 'Add 5 proxies this week',
                'metric_type' => 'proxies',
                'target_value' => 5,
                'love_reward' => 75,
                'experience_reward' => 100,
            ...
            [
                ...
                'description' => 'Create 10 MEXC accounts this month',
                'metric_type' => 'mexc_accounts',
                'target_value' => 10,
                'love_reward' => 300,
            ...
            [
                ...
                'description' => 'Create 10 email accounts this month',
                'metric_type' => 'email_accounts',
                'target_value' => 10,
                'love_reward' => 200,
            ...
            [
                ...
                'description' => 'Add 10 proxies this month',
                'metric_type' => 'proxies',
                'target_value' => 10,
                'love_reward' => 200,
                'experience_reward' => 350,
            ...
            [
                ...
                'description' => 'Create 10 Web3 wallets this month',
                'metric_type' => 'web3_wallets',
                'target_value' => 10,
                'love_reward' => 150,
            ...
            [
                ...
                'description' => 'Complete 10 tasks this month',
